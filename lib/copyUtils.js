...
const { FILE_PATH_ERROR, STR_TYPE_ERROR, INDEX_TRANSFORM_ERROR, SYAML_TRANSFORM_ERROR } = require('./errorCode');
...
const ROUTER_OUTBOUND_URL = `${pwd}/outbound/index.js`;
const SYAML_OUTBOUND_URL = `${pwd}/outbound/s.yaml`;
const PACKAGE_OUTBOUND_URL = `${pwd}/outbound/package.json`;
