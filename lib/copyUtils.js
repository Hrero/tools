...
const CWD_PACKAGE_URL = `${process.cwd()}/package.json`;


const MAIN_TEMPLATE_URL = `${pwd}/template/mainTemplate.js`;
const ROUTER_TEMPLATE_URL = `${pwd}/template/routerTemplate.js`;
const SYAML_TEMPLATE_URL = `${pwd}/template/s.yaml`;
const PACKAGE_TEMPLATE_URL = `${pwd}/template/packageTemplate.json`;
const USER_PACKAGE_TEMPLATE_URL = `${pwd}/template/userPackageTemplate.json`;

const CREATE_OUTBOUND_URL = `${outbound}/outbound`;
const ROUTER_OUTBOUND_URL = `${outbound}/outbound/index.js`;
const SYAML_OUTBOUND_URL = `${outbound}/outbound/s.yaml`;
const PACKAGE_OUTBOUND_URL = `${outbound}/outbound/package.json`;
